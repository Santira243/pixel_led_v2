/*
 * LED PIXEL - WS2812B - MATRIX 
 *          Argentina - 2017
 * Mastricola - Romero Ayala - Villanueva
 * FI UNER  - TEEMBU - LABLUCES 
 * Ver- 0.02
 * IP FIJA
 */
...
#include <avr/power.h>
#endif
#define PIN            5  //OUTPUT PIN D1
#define NUMPIXELS      1620  //NUMBER OF PIXEL TO CONTROL
...
const int PACKET_SIZE = 1357;  // IMPORTANT FOR JINX CONFIG see Patch
